...
insert into hotel (codigo, direccion, nombre, numero_de_estrellas,administrador_hotel_cedula ,destino_codigo) values (1, "Bogota Avenida Goku  ", "Hotel Ciudad Fria", 5, "2345678901",1);
insert into hotel (codigo, direccion, nombre, numero_de_estrellas,administrador_hotel_cedula,destino_codigo) values (2, "Medellin Avenida Hogwarts", "Hotel Ciudad De Las Luces", 5, "3729278392",2);
insert into hotel (codigo, direccion, nombre, numero_de_estrellas,administrador_hotel_cedula,destino_codigo) values (3, "Cartagena Avenida Vegeta", "Hotel Ciudad Amurallada", 5,"4623829300" ,1);
insert into hotel (codigo, direccion, nombre, numero_de_estrellas,administrador_hotel_cedula,destino_codigo) values (4, "Manizales Avenida Albus", "Hotel Ciudad Manizales", 5, "2345678901",1);
...
insert into cliente values ("1000000001", "josea.ramireze@uqvirtual.edu.co", "Jose Ramirez", "josepassword", 1);
insert into cliente values ("1000000002", "caflorez@uniquindio.edu.co", "Camilo Quintero", "camilopassword", 2);
insert into cliente values ("1000000003", "josealfredore133@gmail.com", "Juan Fonseca", "juanpassword", 3);

insert into vuelo (codigo, cantidad_de_sillas, destino_codigo, origen_codigo, fecha) values (1, 11, 1, 3, "2022-12-05");
...
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (2, 1, 2, 300000, 1);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (3, 1, 3, 300000, 1);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (4, 1, 4, 300000, 1);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (5, 1, 5, 300000, 1);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (6, 1, 5, 300000, 1);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (7, 1, 7, 300000, 1);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (8, 1, 8, 300000, 1);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (9, 1, 9, 300000, 1);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (11, 1, 1, 300000, 2);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (12, 1, 2, 300000, 2);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (13, 1, 3, 300000, 2);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (14, 1, 4, 300000, 2);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (15, 1, 5, 300000, 2);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (16, 1, 6, 300000, 2);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (17, 1, 7, 300000, 2);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (18, 1, 8, 300000, 2);
insert into silla (codigo, disponibilidad, numero, valor, vuelo_codigo) values (19, 1, 9, 300000, 2);
